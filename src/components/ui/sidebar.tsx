...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className={cn("group hidden md:flex md:flex-col md:border-r bg-card text-card-foreground",
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex h-screen flex-1 flex-col bg-background",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-3", state === 'collapsed' && 'px-2 items-center', className)}
      {...props}
    />
  )
})
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-muted-foreground outline-none ring-ring focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
>(({ className, showIcon = true, ...props }, ref) => {
  ...
  return (
    <div
      ...
      className={cn("rounded-md h-9 flex gap-2 px-2 items-center", state === 'collapsed' && 'justify-center p-0', className)}
      {...props}
    >
      {showIcon && (
        <Skeleton
