...
import { MessageSquare, Users, Settings, LogOut, Loader2, User, Shield, MessageCircle, ArrowLeft } from 'lucide-react';
...
export function ChatView() {
  ...
  useEffect(() => {
    ...
    const q = query(usersCollection); // Removed the 'where' clause that was causing issues
        ...
        <div className='flex flex-col h-screen bg-background'>
            ...
            <main className="flex-1 overflow-y-auto p-4">
                {isMessagesLoading ? (
                    ...
                    activeChat ? <MessageList messages={messages} currentUserId={user.uid} /> : <div className='flex h-full w-full flex-col items-center justify-center text-center'><MessageSquare className='h-12 w-12 text-muted-foreground' /><p className='mt-4 text-muted-foreground'>Select a chat to start messaging</p></div>
                )}
            </main>
            {activeChat && (
